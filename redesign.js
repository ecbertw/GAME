...
const gameTools=make('div','rx-game-utilities'),playLayout=make('div','rx-play-layout'),playMain=make('div','rx-play-main'),social=make('aside','rx-social'),rankWrap=make('section','rx-rank-wrap'),rankTabs=make('div','rx-rank-tabs');
rankTabs.setAttribute('aria-label',t('Âmbito do ranking','Ranking scope'));
rankWrap.append(rankTabs,boards);social.append(rankWrap,chat);playLayout.append(playMain,social);views.jump.append(gameTools,switcher,intro,playLayout);playMain.append(hero);
