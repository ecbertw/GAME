(() => {
  ...
  const labels={
    ...
    it:{settings:'IMPOSTAZIONI',customize:'PERSONALIZZA NOME',bugs:'SEGNALA BUG',suggestions:'SUGGERIMENTI',contact:'CONTATTI',logout:'ESCI',vipSoon:'ACQUISTA VIP',vipCustomize:'PERSONALIZZA NOME VIP',signIn:'ACCEDI'},
    ja:{settings:'設定',customize:'名前を変更',bugs:'バグを報告',suggestions:'提案',contact:'お問い合わせ',logout:'ログアウト',vipSoon:'VIP 購入',vipCustomize:'VIP名をカスタマイズ',signIn:'ログイン'},
    ko:{settings:'설정',customize:'이름 변경',bugs:'버그 신고',suggestions:'제안',contact:'문의하기',logout:'로그아웃',vipSoon:'VIP 구매',vipCustomize:'VIP 이름 변경',signIn:'로그인'},
    zh:{settings:'设置',customize:'自定义名称',bugs:'报告错误',suggestions:'建议',contact:'联系',logout:'退出登录',vipSoon:'购买 VIP',vipCustomize:'自定义 VIP 名称',signIn:'登录'},
    ru:{settings:'НАСТРОЙКИ',customize:'ИЗМЕНИТЬ ИМЯ',bugs:'СООБЩИТЬ ОБ ОШИБКЕ',suggestions:'ПРЕДЛОЖЕНИЯ',contact:'КОНТАКТ',logout:'ВЫЙТИ',vipSoon:'КУПИТЬ VIP',vipCustomize:'НАСТРОИТЬ VIP-ИМЯ',signIn:'ВОЙТИ'},
