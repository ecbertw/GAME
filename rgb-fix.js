...
(function(){
 ...
 css.textContent=`@property --eixo-rgb-hue{syntax:"<angle>";inherits:true;initial-value:0deg}.rank-player-name.name-rgb,.rank-player-name.name-rainbow,.name-preview.name-rgb,.name-preview.name-rainbow{color:transparent!important;-webkit-text-fill-color:transparent!important;background:none!important;animation:eixo-rgb-hue-cycle 2.4s linear infinite!important}.rank-player-name.name-rgb .name-letter,.rank-player-name.name-rainbow .name-letter,.name-preview.name-rgb .name-letter,.name-preview.name-rainbow .name-letter{color:hsl(calc(var(--eixo-rgb-hue) + var(--i) * 28deg),100%,60%)!important;-webkit-text-fill-color:hsl(calc(var(--eixo-rgb-hue) + var(--i) * 28deg),100%,60%)!important;background:none!important}@keyframes eixo-rgb-hue-cycle{from{--eixo-rgb-hue:0deg}to{--eixo-rgb-hue:360deg}}`;
